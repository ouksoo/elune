let ELUNE = {
    ...
    utils: function() {
        ...
        //character tab
        $('div.area-character .man-tab a, div.area-character .thumb a').on('click', function(e) {
            let thisNum = $(this).data('num');
            let thisKind = $(this).data('kind');
            if(thisKind) {
                $('div.area-character .man-tab a').each(function() {
                    $(this).removeClass('on');
                });
                $(this).addClass('on');
            }
        ...
        $('.multimedia-tab a').on('click', function(e) {
            ...
            $(this).addClass('on');
            $('.gallery-outside .gallery-wrap').css('display','none');
